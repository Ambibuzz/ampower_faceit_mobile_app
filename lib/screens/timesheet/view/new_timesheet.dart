...
import 'package:community/screens/timesheet/api_requests/web_requests.dart';
import 'package:community/screens/timesheet/view/add_timesheet.dart';
import 'package:community/screens/timesheet/viewmodel/newtimesheet_viewmodel.dart';
...
class NewTimeSheet extends StatelessWidget{
  @override
  Widget build(BuildContext context){
    return BaseView<NewTimeSheetViewModel>(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            enabled: false,
                            initialValue: model.data[0]['employee'],
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            enabled: false,
                            initialValue: model.data[0]['employee_name'],
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton(
                                hint: const Text('Enter customer'),
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            enabled: false,
                            initialValue: model.data[0]['company'],
                              ...
                              onTap: (){
                                if(model.formKey.currentState!.validate()){
                                  ...
                                  for(int i=0; i<model.timesheets.length; i++){
                                    totalHours += int.parse(model.timesheets[i]['hrs']);
                                  }
                                  Map<String,dynamic> timeSheetData = {
                                    "company": model.data[0]['company'],
                                    "currency": model.selectedCurrency,
                                    "status": 'Draft',
                                    "total_hours": totalHours,
                                    "time_logs": [
                                      for(int i=0; i<model.timesheets.length; i++){
                                        "completed": model.timesheets[i]['is_completed'] ? 1 : 0,
                                        "is_billable": model.timesheets[i]['is_billable'] ? 1 : 0,
                                        "activity_type": model.timesheets[i]['activity_type'],
                                        "from_time": model.timesheets[i]['from_date'],
                                        "hours": int.parse(model.timesheets[i]['hrs']),
                                    ...
                                    "employee": model.data[0]['employee'],
                                    "employee_name": model.data[0]['employee_name'],
                                    "customer": model.selectedCustomer
                                  };

                                  WebRequests().createTimesheet(timeSheetData).then((value) => {
                                    if(value!['success']){
                                      showDialog(
                                        context: context,
                                          ...
                                          content: SizedBox(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                const SizedBox(height: 20,),
                                                const Text('Timesheet Created Succesfully!',textAlign: TextAlign.center,),
                                                const SizedBox(height: 20),
                                                InkWell(
                                                  onTap: (){
